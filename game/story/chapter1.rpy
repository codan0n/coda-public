...
label college_orientation:
    ...
    scene bg campus summer night with dissolve
...
#            player "Yeah can I get uhh...."
    ...
    menu:
        n "{cps=0}{font=ahellya.ttf}Мишка{/font}{/cps}"
        "Myewka?":
...
label afterAvaText1:
    ...
    if bedpilled == True:
        ...
        scene bg campus summer night with fade
...
label thursday1:
    ...
    menu:
        ...
        "I'd love to!":
            ...
            call claireFrenchStudy1 from _call_claireFrenchStudy1
