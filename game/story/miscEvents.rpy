...
label claireFrenchStudy2:
    ...
    if avaClaireDormIntroSeen == False:
        call avaClaireDormIntro from _call_avaClaireDormIntro_1
    ...
    show claire topless surprised earsup at center with dissolve:
        ypos y_claire
    ...
    show claire topless suggestive earsup
    ...
    if frenchSkill < 5:
        ...
        show claire topless flustered
        
        claire @ say "I mean... tu penses vraiment que je suis mignon?"
        
        menu:
            claire "{cps=0}I mean... tu penses vraiment que je suis mignon?{/cps}"
            "The cutest!":
                $ clairePoints += 1
    ...
    scene claire study 2 with fade
    ...
    menu:
        n "{cps=0}Her distraction makes it difficult to continue your study/roleplay session.{/cps}"
        "Get flirty":
            $ clairePoints += 1
            ...
            show claire topless happy at center with dissolve:
                ypos y_claire
            ...
            player "Like a make out break or something."
            ...
            show ava typical at offscreenright:
                ypos y_ava
            
            show ava typical concerned at center with move:
                xoffset 400
                ypos y_ava
            ...
            if avaCommitted == True:
                ...
                ava @ say "Are you really just gonna steal him away from me like that?!"
                ...
                menu:
                    claire "{cps=0}I can't help it if he falls for *my* charm instead!~{/cps}"
                    "We were just acting out a scene":
                        ...
                        show ava topless whimsical
                        
                        ava @ say "Claire goes full nude most of the time."
                        
                        show claire topless flustered
                        show ava topless happy
                        ...
                        show claire topless happy
                        show ava topless excited
                        
                        ava @ say "We should totally hang out at your dorm more often though!"
                        ...
                        ava @ say "That's just how girls are. The more we bicker, the stronger our friendship gets!"
                        ...
                        player "Nah, we just call each other homophobic slurs and urge them to commit suicide."
                        ...
                        show claire topless happy
                        show ava topless angry
                        
                        ava @ say "Hey!"
                        ava @ say "If you don't kill yourself right now I'm gonna come over there and strangle you myself!"
                        
                        show ava topless overjoyed
                        
                        ava @ say "Hahaha you're right [name], that's pretty fun to say!"
                        
                        claire @ say "Ksksksks I'd like to see a raging dyke like you try choking me~"
                    ...
                    "If you can like 2 boys I can like 2 girls" if avaPoints > 5:
                        ...
                        ava @ say "Don't you dare, or it's open season on rabbits!"
                ...
                menu:
                    ava "{cps=0}OMG were you two about to kiss??{/cps}"
                    "Yeah, kinda":
                        ...
                        ava @ say "Not true! I'm still considering my feelings for him!"
                        ...
                        menu:
                            ava "{cps=0}I'll get with one of them when I'm good and ready!{/cps}"
                            "Claire's right":
