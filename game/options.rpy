...
label message(who, what, pic):
    ...
    if who.lower() == "me":
        show screen phone_message2(who, what, pic)
    else:
        show screen phone_message(who, what, pic)
    return
...
label message_start(who, what, pic):
    # if you want to change the players name to be something else than "me" you can change it here
    if who.lower() == "me":
        show screen phone_message2(who, what, pic)
    else:
...
default preferences.text_cps = 155

#default preferences.gl_framerate = 144
...
define config.save_directory = "CODA-1615669357"
